...
| `treat_missing_referer_as_phishing` | `ENTRA_TREAT__MISSING__REFERER__AS__PHISHING` | Treat a missing referer header as a phishing attempt and show the image. If set to false, a missing referer will be treated as a valid login. Default: true                                                 |
